...
export async function sendCampaignApprovedEmail(sponsor: any, campaign: any) {
...
export async function sendNewProposalEmail(projectOwner: any, project: any, proposal: any) {
...
export async function sendPaymentReceivedEmail(user: any, amount: number, type: 'received' | 'released') {
