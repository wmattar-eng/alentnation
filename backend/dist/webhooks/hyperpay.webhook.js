...
exports.hyperpayWebhookService = void 0;
...
exports.hyperpayWebhookService = {
    ...
    async checkPaymentStatus(checkoutId) {
        const response = await fetch(`${HYPERPAY_BASE_URL}/v1/checkouts/${checkoutId}/payment`, {
            headers: {
...
async function handleSuccess(paymentId, payload) {
...
async function handlePending(paymentId, payload) {
    await app_1.prisma.payment.update({
        where: { id: paymentId },
        data: {
            status: 'PENDING',
...
async function handleFailure(paymentId, payload) {
    await app_1.prisma.payment.update({
        where: { id: paymentId },
        data: {
            status: 'FAILED',
...
//# sourceMappingURL=hyperpay.webhook.js.map